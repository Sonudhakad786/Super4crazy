...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '-1002180704810').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002180704810')) #Log channel id ( make sure bot is admin )
